...
exports.examples = [
  ...
  },
  {
    ...
    platform: 'ios',
    render(): ReactElement<any> {
      return <SliderExample trackImage={require('../img/uie_thumb_big.png')} />;
    }
  },
  {
    ...
    render(): ReactElement<any> {
      return (
        <SliderExample
          minimumTrackImage={require('../img/uie_thumb_big.png')}
          maximumTrackImage={require('../img/uie_thumb_big.png')}
        />
      );
    }
  },
...
module.exports = SlidingCompleteExample;